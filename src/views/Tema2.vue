  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1(data-aos="fade-right") Territorio
      ...
      SlyderA(tipo="b")
        .row.justify-content-center.align-items-center
          .col-11.col-lg-5.mb-4.mb-md-0
            h4.mb-4 Las clases 1, 2 y 3 
            p Aptos para los desarrollos agrícolas y el ganado controlado, pero también se permite cultivos transitorios, al igual que la ganadería intensiva con pastos de alto rendimiento; solo necesitan prácticas como fertilización, encalamiento, riego y drenaje.
        ...
        .row.justify-content-center.align-items-center
          .col-11.col-lg-5.mb-4.mb-md-0
            h4.mb-4 Clase 4 
            p Es apta para usos agrícola y pecuario, pero debido a sus limitantes requieren de prácticas de manejo agropecuarias difíciles de aplicar y mantener.
    ...
    #t_2_3.titulo-segundo.color-acento-contenido(data-aos="zoom-out-right")
        h2 2.3. Características biofísicas 
    ...
    p.mb-4 En la siguiente infografía se puede analizar las principales características y biofísicas del suelo: 
